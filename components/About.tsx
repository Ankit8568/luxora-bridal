          ...
          >
            ...
            <div className="mt-8 grid grid-cols-2 gap-5 sm:mt-10 sm:gap-10">
              <div className="border-r border-[#211b18]/15 pr-4">
                ...
                <p className="mt-2 max-w-[120px] text-xs leading-5 text-[var(--muted)] sm:text-sm">
                  Years of Experience
                </p>
              </div>
            ...
            {/* SIGNATURE TEXT */}
            <p className="mt-8 font-display text-xl italic leading-8 text-[var(--accent)] sm:mt-10 sm:text-2xl">
